label chapter1:
    #(Alarm Buzzing)
    mc_unrevealed "Wha.. ? {w} Its morning already ?"
    ...
    mc_unrevealed "Damn, what am i talking to myself ?"
    ...
    mc_inner "This is my Uncle, Bob. {p} Bob is the Chief Mechanic of the Pilot Academy, and also my guardian."
    mc_inner "He has taken me since i was little."

    #Change scene: School Outskirts
    bob "Put your spirits into it! One-two One-two One-TAWOOO"
    mc_inner "I never had any parents since i was an orphan, so Bob is the closest parent figure to me."
